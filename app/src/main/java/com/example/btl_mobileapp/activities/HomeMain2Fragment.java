...
import androidx.constraintlayout.widget.ConstraintLayout; // Hoặc View, LinearLayout...
...
public class HomeMain2Fragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        if (sharedPreferences != null && rootLayout != null) {
    ...
    // ... (Hàm calculateAndDisplayLoveDays, bindUserProfile, displayCachedData, safeSetText giữ nguyên) ...
    ...
    /**
     * Sao chép hàm loadSavedBackground từ HomeMain1Fragment
     */
    private void loadSavedBackground() {
        if (sharedPreferences != null) {
            ...
            if (savedUrlOrId != null && !savedUrlOrId.isEmpty()) {
                ...
                if (rootLayout != null) {
                    rootLayout.setBackgroundResource(R.drawable.background_home); // Đặt nền mặc định của bạn
                }
            }
        }
    }
    ...
    /**
     * Sao chép hàm loadBackgroundFromUrl từ HomeMain1Fragment
     */
    private void loadBackgroundFromUrl(String url) {
        if (url == null || url.isEmpty() || !isAdded() || rootLayout == null) {
            ...
            if (rootLayout != null && rootLayout.getBackground() == null) {
                rootLayout.setBackgroundResource(R.drawable.background_home); // Đặt nền mặc định
            }
            return;
        }
    ...
    // Các hàm còn lại của bạn (calculateAndDisplayLoveDays, bindUserProfile, ...)
    // ...
    private void calculateAndDisplayLoveDays() {
        ...
        // 3. Cập nhật UI
        safeSetText(tvDaysCount, String.valueOf(totalDays) + " ngày");
