...
public class DatabaseManager {
    ...
    public void sendMessage(String coupleId, String senderId, String senderName, String messageText, DatabaseActionCallback callback) {
        com.example.couple_app.models.Message message = new com.example.couple_app.models.Message(coupleId, senderId, senderName, messageText);
    ...
    public void getMessages(String coupleId, DatabaseCallback<List<com.example.couple_app.models.Message>> callback) {
        db.collection(MESSAGES_COLLECTION)
            .whereEqualTo("coupleId", coupleId)
            .orderBy("timestamp", com.google.firebase.firestore.Query.Direction.ASCENDING)
            .get()
            .addOnSuccessListener(queryDocumentSnapshots -> {
                List<com.example.couple_app.models.Message> messages = new ArrayList<>();
                for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                    com.example.couple_app.models.Message message = doc.toObject(com.example.couple_app.models.Message.class);
    ...
    public com.google.firebase.firestore.ListenerRegistration listenForMessages(String coupleId, DatabaseCallback<List<com.example.couple_app.models.Message>> callback) {
