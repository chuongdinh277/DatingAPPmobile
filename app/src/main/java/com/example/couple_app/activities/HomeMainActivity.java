...
import com.example.couple_app.fragments.ChatbotBottomSheetFragment;
import com.example.couple_app.fragments.ChatbotHost;
import com.example.couple_app.utils.AvatarCache;
import com.example.couple_app.views.DraggableImageView;
            ...
            .addOnCompleteListener(task -> {
                ...
                if (token != null && !token.isEmpty()) {
                    ...
                    com.example.couple_app.managers.DatabaseManager.getInstance()
                        .updateUserFcmToken(userId, token, new com.example.couple_app.managers.DatabaseManager.DatabaseActionCallback() {
                            @Override
