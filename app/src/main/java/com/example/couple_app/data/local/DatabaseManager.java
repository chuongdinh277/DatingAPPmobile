package com.example.couple_app.data.local;
...
import com.example.couple_app.data.model.AISuggestion;
...
public class DatabaseManager {
    ...
    public void sendMessage(String coupleId, String senderId, String senderName, String messageText, DatabaseActionCallback callback) {
        Message message = new Message(coupleId, senderId, senderName, messageText);
    ...
    public void getMessages(String coupleId, DatabaseCallback<List<Message>> callback) {
        db.collection(MESSAGES_COLLECTION)
            .whereEqualTo("coupleId", coupleId)
    ...
    public com.google.firebase.firestore.ListenerRegistration listenForMessages(String coupleId, DatabaseCallback<List<Message>> callback) {
