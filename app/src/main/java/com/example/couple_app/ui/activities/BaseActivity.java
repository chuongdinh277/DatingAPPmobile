...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private void removeRestoredChatBottomSheetIfAny(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (existing != null) {
                ...
                if (existing instanceof com.example.couple_app.ui.fragments.ChatBottomSheetFragment) {
                    try {
                        ((com.example.couple_app.ui.fragments.ChatBottomSheetFragment) existing).dismissAllowingStateLoss();
    ...
    private void loadPartnerInfoAndOpenChat() {
        ...
        databaseManager.getCoupleByUserId(currentUserId, new com.example.couple_app.data.local.DatabaseManager.DatabaseCallback<com.example.couple_app.data.model.Couple>() {
            @Override
            public void onSuccess(com.example.couple_app.data.model.Couple couple) {
                ...
                // Get partner details
                databaseManager.getUser(partnerId, new com.example.couple_app.data.local.DatabaseManager.DatabaseCallback<com.example.couple_app.data.model.User>() {
                    @Override
                    public void onSuccess(com.example.couple_app.data.model.User partner) {
    ...
    private void openChatBottomSheetDirectly(String partnerId, String partnerName, String partnerAvatar, String coupleId) {
        try {
            ...
            com.example.couple_app.ui.fragments.ChatBottomSheetFragment chatFragment =
                com.example.couple_app.ui.fragments.ChatBottomSheetFragment.newInstance(
            ...
            new android.os.Handler(android.os.Looper.getMainLooper()).postDelayed(() -> {
                if (!isFinishing() && !isDestroyed()) {
                    ...
                    if (fragment instanceof com.example.couple_app.ui.fragments.ChatBottomSheetFragment) {
                        android.app.Dialog dialog = ((com.example.couple_app.ui.fragments.ChatBottomSheetFragment) fragment).getDialog();
                        if (dialog != null) {
