...
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void firebaseAuthWithGoogle(String idToken) {
        ...
        if (lastSignedInAccount != null && lastSignedInAccount.getEmail() != null) {
            ...
            com.example.couple_app.data.local.DatabaseManager.getInstance().checkEmailExists(
                googleEmail,
                new com.example.couple_app.data.local.DatabaseManager.DatabaseCallback<com.example.couple_app.data.model.User>() {
                    @Override
